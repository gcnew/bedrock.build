...
var groupBy = require('./util/groupBy');
var DependencyManager = require('./DependencyManager');
var DirectiveParsers = require('./DirectiveParsers');
...
function collectDependencies(aRoot, dependencyManager) {
	...
	for (var next; next = dependencyManager.nextUnresolved();) {
		...
		if (!groups['exports']) {
			...
			var exports = Array.prototype.concat.apply([], groups['exports']);
